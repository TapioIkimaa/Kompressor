...
internal class ZlibCompressorImpl(
    ...
    private val initResult = deflateInit2(stream.ptr, compressionLevel, Z_DEFLATED, windowBits, memLevel, strategy)
    ...
    override fun transform(input: ByteArraySlice, output: ByteArraySlice, finish: Boolean) = memScoped {
        input.data.usePinned { pinnedInput ->
            output.data.usePinned { pinnedOutput ->
                ...
                val result = deflate(stream.ptr, if (finish) Z_FINISH else Z_NO_FLUSH)
